...
public enum ModArmorMaterials implements ArmorMaterial {
    RESONANT("resonant", 35, new int[] {4, 8, 8, 4}, 30,
            SoundEvents.BLOCK_SCULK_SENSOR_CLICKING, 3.0f, 0f, () -> Ingredient.ofItems(ModItems.SCULK_PILE));
    ...
    public String getName() {
        return Ensculked.MOD_ID + ":" + this.name;
    }
